...
page = 1
while True:
    url = f"{BASE}/posts?per_page=100&page={page}&_embed=1&_fields=id,slug,title,date,modified,link,featured_media,excerpt,_links,_embedded"
...
print(f"TOTAL={len(posts)} WITH_IMAGE={with_img} WITHOUT={len(posts)-with_img}", file=sys.stderr)
